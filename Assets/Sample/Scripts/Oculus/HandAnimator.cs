...
{
    [RequireComponent(typeof(GrabberWeapon))]
    public class HandAnimator : MonoBehaviour
    {
        ...
        private GrabberWeapon m_grabber;
        ...
        private void Awake()
        {
            m_grabber = GetComponent<GrabberWeapon>();
        }
        private void Start()
        {
        ...
        private void UpdateAnimStates()
        {
            ...
            //if (grabbing)
            //{
            //    OculusHandPose customPose = m_grabber.grabbedObject.GetComponent<OculusHandPose>();
